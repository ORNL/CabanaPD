...
TEST( TEST_CATEGORY, test_force_pmb_binary )
{
    ...
    static_assert( std::is_same_v<decltype( model1 )::force_tag,
                                  typename decltype( models )::force_tag> );
...
template <typename ModelType, typename ForceType, typename FractureType,
